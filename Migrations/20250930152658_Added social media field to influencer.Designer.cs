...
namespace MaillotStore.Migrations
{
    ...
    [Migration("20250930152658_Added social media field to influencer")]
    partial class Addedsocialmediafieldtoinfluencer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaillotStore.Models.Commission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaillotStore.Models.Influencer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaillotStore.Models.Commission", b =>
                {
                    b.HasOne("MaillotStore.Models.Influencer", "Influencer")
                        .WithMany("Commissions")
                        .HasForeignKey("InfluencerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MaillotStore.Models.Order", "Order")
                        .WithMany()
